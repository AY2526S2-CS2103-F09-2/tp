 ...
 *     e.g. {@code some preamble text -tag 11.00 -tag 12.00 -keyword July}.<br>
 * 1. An argument's value can be an empty string e.g. the value of {@code -keyword} in the above example.<br>
...
public class ArgumentTokenizer {
     ...
     *
     * E.g if {@code argsString} = "-email hip-phone-900", {@code prefix} = "-phone" and
